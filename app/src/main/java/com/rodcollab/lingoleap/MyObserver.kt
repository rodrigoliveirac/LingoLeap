...
class MyObserver(private val searchHistory: HistoryViewModel, private val savedViewModel: SavedViewModel, private val viewModel: SearchViewModel) : DefaultLifecycleObserver {
    override fun onResume(owner: LifecycleOwner) {
        super.onResume(owner)
        viewModel.onResume()
        savedViewModel.showList()
        searchHistory.onResume()
    }
}